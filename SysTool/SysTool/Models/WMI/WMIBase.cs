...
namespace SysTool.Models.WMI {
    public abstract class WMIBase {
        ...
        public void Save(IEnumerable<PropertyInfo> updatedProperties, PutOptions? options = default) {
        ...
        private void UpdatePropertyValues(IEnumerable<PropertyInfo> updatedProperties) {
