...
[assembly: SuppressMessage("Naming", "CA1707:Identifiers should not contain underscores", Justification = "<Pending>", Scope = "member", Target = "~P:SysTool.Models.WMI.ds_user.DS_cn")]
[assembly: SuppressMessage("Naming", "CA1707:Identifiers should not contain underscores", Justification = "<Pending>", Scope = "member", Target = "~P:SysTool.Models.WMI.ds_user.DS_memberOf")]
...
[assembly: SuppressMessage("Design", "CA1062:Validate arguments of public methods", Justification = "<Pending>", Scope = "member", Target = "~M:SysTool.Extensions.TypeExtensions.GetPublicInstanceProperties(System.Type)~System.Collections.Generic.IEnumerable{System.Reflection.PropertyInfo}")]
[assembly: SuppressMessage("Naming", "CA1716:Identifiers should not match keywords", Justification = "<Pending>", Scope = "member", Target = "~M:SysTool.Repositories.IRepository`1.Get(System.String,System.String)~System.Linq.IQueryable{`0}")]
...
[assembly: SuppressMessage("Reliability", "CA2007:Consider calling ConfigureAwait on the awaited task", Justification = "<Pending>", Scope = "member", Target = "~M:SysTool.Program.ShowMainForm(SysTool.Forms.MainForm)~System.Threading.Tasks.Task")]
...
[assembly: SuppressMessage("Naming", "CA1716:Identifiers should not match keywords", Justification = "<Pending>", Scope = "member", Target = "~M:SysTool.Repositories.IRepository.Get``1(System.String,System.String)~System.Linq.IQueryable{``0}")]
...
[assembly: SuppressMessage("Reliability", "CA2007:Consider calling ConfigureAwait on the awaited task", Justification = "<Pending>", Scope = "member", Target = "~M:SysTool.Program.HandleExceptions(System.Threading.Tasks.Task)")]
[assembly: SuppressMessage("Reliability", "CA2007:Consider calling ConfigureAwait on the awaited task", Justification = "<Pending>", Scope = "member", Target = "~M:SysTool.Program.StartAsync~System.Threading.Tasks.Task")]
[assembly: SuppressMessage("Reliability", "CA2007:Consider calling ConfigureAwait on the awaited task", Justification = "<Pending>", Scope = "member", Target = "~M:SysTool.Forms.LoadForm.LoadForm_Load(System.Object,System.EventArgs)")]
[assembly: SuppressMessage("Reliability", "CA2007:Consider calling ConfigureAwait on the awaited task", Justification = "<Pending>", Scope = "member", Target = "~M:SysTool.Program.ShowForm(System.Windows.Forms.Form,System.Func{System.Threading.Tasks.Task})~System.Threading.Tasks.Task")]
[assembly: SuppressMessage("Reliability", "CA2007:Consider calling ConfigureAwait on the awaited task", Justification = "<Pending>", Scope = "member", Target = "~M:SysTool.Forms.LoadForm.InitializeAsync~System.Threading.Tasks.Task")]
[assembly: SuppressMessage("Reliability", "CA2007:Consider calling ConfigureAwait on the awaited task", Justification = "<Pending>", Scope = "member", Target = "~M:SysTool.Forms.MainForm.InitializeAsync~System.Threading.Tasks.Task")]
